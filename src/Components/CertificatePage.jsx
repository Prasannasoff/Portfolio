            ...
            <div className="w-[95%] flex mx-auto">
                <div className="flex justify-center lg:flex-row flex-col items-center">
                    <div ref={colLeftRef} className="w-1/2 h-full">
                        <div className="lg:text-[70px] text-[30px] lg:items-start items-center flex flex-col font-extrabold lg:leading-[85%] lg:border-l-[3px] border-[#ff98a2] lg:pl-[25px] m-0 uppercase">
                            <span>My</span>
                            <span>Certificates</span>
                        </div>
                    </div>
                    <div className="lg:w-2/5 min-w-[320px] flex flex-col gap-[15px]">

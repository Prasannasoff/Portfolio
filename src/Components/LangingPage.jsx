            ...
            <div id="home" className='flex h-full w-screen py-10 p-7 gap-6 flex-col justify-center xl:flex-row lg:flex-row overflow-hidden items-center' >
                ...
                <div className='flex xl:gap-4 lg:gap-6 gap-8 items-center xl:items-start lg:items-start w-[700px] flex-col ml-0 xl:ml-20 lg:ml-20'>
                    ...
                    <div className='flex flex-row gap-3'>
                        <div className='flex flex-row cursor-pointer  bg-orange-400 rounded-3xl p-2 font-Roboto items-center justify-center h-12 gap-3 w-40' onClick={() => window.open('https://mail.google.com/mail/?view=cm&fs=1&to=prasannas.22cse@kongu.edu', '_blank')}>
                        ...
                        <a a href="https://drive.google.com/file/d/1hU-8yUxHy5HInUCraLj6HDOEzsr7GNrV/view?usp=sharing" download="Sandhish_Resume.pdf"
                            className='bg-white rounded-3xl p-2 flex items-center font-Roboto justify-center h-12 gap-3 w-40'>
                    ...
                    <div className='flex mt-0 flex-row gap-5 items-center md:-mt-4 md:p-3 lg:pl-3 xl:pl-3 lg:mt-5 xl:mt-5'>
                        ...
                        <a href='https://leetcode.com/Prasannas02'>
                            <div className='w-8 h-8 cursor-pointer hover:scale-150 bg-white p-1 rounded-md' >
